...
const CreateCustomerForm = (props) => {
  ...
  return (
    <form
      className="bg-gray-100 min-w-[30%] max-w-4xl p-5 mt-5 rounded shadow-lg md:mx-5"
    ...
    >
      ...
      { error && <div className="bg-[#ffefef] p-2 max-w-80 border-solid border-2 border-red-600 rounded-xl">{error}</div>}
    </form>
  );
};
